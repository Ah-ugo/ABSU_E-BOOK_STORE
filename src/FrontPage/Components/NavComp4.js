...
export default function NavComp4() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  return (
    <header className="bg-white">
      <nav
        className="flex max-w-7xl items-center justify-between p-6 "
        aria-label="Global">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 no-underline text-gray-900 hover:bg-gray-50">
                  Features
                </a>
                <a
                  href="#"
                ...
                <a
                  href="#"
                  className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 no-underline hover:bg-gray-50">
                  Company
                </a>
              </div>
              <div className="py-6">
